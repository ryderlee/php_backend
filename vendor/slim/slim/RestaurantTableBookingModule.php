	...
	private static function setStaticVar($mid, $bookingDatetime, $covers){
		if(isset(RestaurantTableBookingModule::$mid) && ( RestaurantTableBookingModule::$mid == $mid) && 
			...
			*/
			...
			RestaurantTableBookingModule::$sessionStartDatetime = $bookingDatetime;			
			RestaurantTableBookingModule::$sessionEndDatetime =  RestaurantTableBookingModule::$sessionStartDatetime + 60 * 120;
